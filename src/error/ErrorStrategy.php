...
interface ErrorStrategy
{
	 ...
	 * @param Parser $recognizer the parser instance
	 * @return Token
	 * @throws RecognitionException if the error strategy was not able to recover from the unexpected input symbol
	 */
	 ...
	 *
	 * @param Parser $recognizer the parser instance
	 * @param RecognitionException $e the recognition exception to recover from
	 ...
	 *
	 * @param Parser $recognizer the parser instance
	 * @throws RecognitionException if an error is detected by the error strategy but cannot be automatically recovered at the current state in the parsing process
	 */
	 ...
	 *
	 * @param Parser $recognizer the parser instance
	 * @return bool {@code true} if the parser is currently recovering from a parse error, otherwise {@code false}
	 */
